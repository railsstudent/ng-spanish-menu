...
@Component({
  ...
  template: `<article>
    <storybook-header
      [user]="user"
      (customLogout)="customLogout.emit($event)"
      (customLogin)="customLogin.emit($event)"
      (customCreateAccount)="customCreateAccount.emit($event)"
    ></storybook-header>
    <section>
...
export default class PageComponent {
  ...
  @Output()
  customLogin = new EventEmitter<Event>()

  @Output()
  customLogout = new EventEmitter<Event>()

  @Output()
  customCreateAccount = new EventEmitter<Event>()
}
